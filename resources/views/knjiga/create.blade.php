...
@section('content')
    ...
    <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
        ...
        <div class="py-4 text-gray-500 border-b-[1px] border-[#e4dfdf] pl-[30px]">
            ...
            <a href="{{route('knjiga.specifikacija')}}" class="inline ml-[70px] hover:text-blue-800 ">
                Specifikacija
            </a>
            <a href="{{route('knjiga.multimedia')}}" class="inline ml-[70px] hover:text-blue-800">
                Multimedija
            </a>
        </div>
        <!-- Space for content -->
                ...
                <div class="flex flex-row ml-[30px] mb-[150px]">
                    <div class="w-[50%]">
                        ...
                        <div class="mt-[20px]">
                            ...
                            <textarea id="kratki_sadrzaj" name="kratki_sadrzaj"
                                      class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]">
        ...
        <div class="mt-[20px]">
            ...
            <select
                ...
                @foreach($izdavaci as $izdavac)
                    <option value="{{$izdavac->Id}}">{{$izdavac->Naziv}}</option>
                @endforeach
            </select>
