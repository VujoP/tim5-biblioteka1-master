                                   ...
                                   @endforeach
                                    ...
                                    {{
                                     $knjiga->UkupnoPrimjeraka-(
                                         $knjiga->getIzdatoKnjigaAttribute()
                                                 +
                                         $knjiga->getRezervisanoKnjigaAttribute()
                                          )
                                     }}</td>
                                    <td class="px-4 py-4 text-sm leading-5 text-blue-800 whitespace-no-wrap"><a
                                            href="aktivneRezervacije.php">{{$knjiga->getRezervisanoKnjigaAttribute()}}</a></td>
                                    <td class="px-4 py-4 text-sm leading-5 text-blue-800 whitespace-no-wrap"><a
                                            href="izdateKnjige.php">{{$knjiga->getIzdatoKnjigaAttribute()}}</a></td>
                                    <td class="px-4 py-4 text-sm leading-5 text-blue-800 whitespace-no-wrap"><a
